...
const AccountCreates = async (req, res) => {
    try {
        ...
        const checkEmail = await createAccount_1.default.findOne({ email });
        if (checkEmail) {
        ...
        const lastAccount = await createAccount_1.default.findOne().sort({ accountNumber: -1 });
        let newAccountNumber = 1000000001;
        if (lastAccount && lastAccount.accountNumber) {
            newAccountNumber = lastAccount.accountNumber + 1;
        }
        const account = new createAccount_1.default({
            fullName,
            email,
        ...
        let token = (0, token_1.default)(account._id, res);
        await account.save();
...
exports.AccountCreates = AccountCreates;
//# sourceMappingURL=createAcount.js.map